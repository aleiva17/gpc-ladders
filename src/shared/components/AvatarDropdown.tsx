...
export const AvatarDropdown = (): ReactElement => {
  return (
      ...
      <Menu.Items className="origin-top-right absolute right-0 top-12 mt-2 w-56 rounded-md shadow-lg bg-white dark:bg-darkest ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none">
        <div className="py-1">
          <Menu.Item>
            <Link
              to="/"
              className="flex items-center w-full px-4 py-2 text-complementary dark:text-complementary-dark hover:text-gpc-purple dark:hover:text-gpc-aqua gap-3"
            >
